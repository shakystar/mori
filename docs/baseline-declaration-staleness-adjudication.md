...
| 8   | `consolidate-evidence-binding-adjudication.md`            | (없음)    | `46789ef`(자기 생성 커밋, #297)                                                                                                                     | 대조 불가                                                                     | **판정불가**[^3]       | **판정불가** — SHA가 없어 오늘도 대조 불가. `37a449d`가 이 문서의 file:줄 토큰 6개도 추가로 옮겼다 — SHA를 심는 순간 이 이동분부터 거짓이 될 것이다 |
