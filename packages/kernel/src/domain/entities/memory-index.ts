...
export interface MemoryIndex {
  ...
  projectId: EntityId;
  shortSummary: string;
  activeWorkstreams: Array<Pick<Workstream, "id" | "title" | "summary" | "status">>;
  topTasks: Array<Pick<Task, "id" | "title" | "status" | "priority" | "latestHandoffId">>;
  recentDecisions: Array<Pick<Decision, "id" | "title" | "status">>;
  openConflicts: Array<Pick<Conflict, "id" | "scopeType" | "conflictType" | "status">>;
