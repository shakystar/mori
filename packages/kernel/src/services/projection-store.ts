...
export interface RebuildProjectProjectionOptions {
   ...
   * `consolidateBoundary` (packages/kernel/src/services/consolidate-service.ts:2906) calls it and
   * falls straight through to `commitBoundaryCursors` (packages/kernel/src/services/consolidate-service.ts:2968) regardless of
