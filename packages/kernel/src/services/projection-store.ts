...
export interface RebuildProjectProjectionOptions {
   ...
   * `consolidateBoundary` (packages/kernel/src/services/consolidate-service.ts:2878) calls it and
   * falls straight through to `commitBoundaryCursors` (packages/kernel/src/services/consolidate-service.ts:2940) regardless of
