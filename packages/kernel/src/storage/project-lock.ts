 ...
 * `inputs.length > 0 || segmentsWritten > 0` (`packages/kernel/src/services/consolidate-service.ts:2905`),
 ...
 * neither cursor moves (`packages/kernel/src/services/consolidate-service.ts:2676-2680`), same as check
