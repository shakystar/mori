...
// timeout이 없는 케이스만 — bin-entrypoint.test.ts/cooperative-cancellation.test.ts는 아래
// 참고). 관측된 최대치:
//   - withProjectLock 재확보 레이스(project-lock-transfer.test.ts): 818ms/753ms/702ms
//   - cap-boundary property invariant2(cap-boundary-properties.test.ts, #188/#220): 761ms/757ms/723ms
//   - runBash 백그라운드 자식 kill(mori/bash.test.ts): 611ms/610ms/606ms
...
// bin-entrypoint.test.ts(30000ms, mori)·cooperative-cancellation.test.ts(60000ms, 이 패키지)는
